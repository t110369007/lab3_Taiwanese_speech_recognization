...
for i in tqdm(range(total)):
    ...
    #features.append(mfcc(audio, sr, numcep=mfcc_dim, nfft=512, highfreq=8000))
...
print("debug 1:", X)
print("debug 1:", Y)
print("debug 1:", X_length)
print("debug 1:", Y_length)
"""
...
"""
print("debug 2:", Y)
print("debug 2:", Y_pred)
print("debug 2:", X_length)
print("debug 2:", Y_length)
"""
...
with open(ROOT_dir +'/sample.csv', 'w', newline='') as csvfile:
  # 建立 CSV 檔寫入器
